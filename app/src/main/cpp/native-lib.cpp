...
void mat2Bitmap(JNIEnv *env, Mat &src, jobject bitmap) {
    ...
    Java_com_sstsj_platenumber_MainActivity_init(JNIEnv *env, jobject instance, jstring svm_,
    ...
    JNIEXPORT void JNICALL
    Java_com_sstsj_platenumber_MainActivity_release(JNIEnv *env, jobject instance) {

        // TODO
        if (carPlateRecgize){
            delete carPlateRecgize;
            carPlateRecgize = NULL;
        }
    }

    JNIEXPORT jstring JNICALL
    Java_com_sstsj_platenumber_MainActivity_recognition(JNIEnv *env, jobject instance, jobject bitmap,
                                                        jobject out) {
